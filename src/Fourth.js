...
function Fourth() {
  return (
    <div className="w-auto h-[90rem] pt-12 md:h-[47rem] sm:h-[88rem]">
        <p className = "text-3xl font-bold w-[30rem] text-center ml-6 sm:w-[35rem] sm:ml-16 md:w-[44rem] md:ml-[20rem]">Integrated with your favourite tools, of course.</p>
        <p className = "text-center w-[28rem] ml-9 mt-5 sm:w-[37rem] sm:ml-10 md:w-[44rem] md:ml-[20rem] md:text-lg">To make work more efficient, Dooly connects dynamically with Salesforce, Gong, Slack, Outreach, Salesloft and your G-Suite tools. Work deals your way.</p>

        <div className= "flex gap-2 mt-7 ml-[9rem] cursor-pointer sm:ml-[14rem] md:ml-[35rem] hover:text-pink-600 text-pink-500 transition duration-300 ease-in-out">
        ...
        <div className="grid grid-rows-1 gap-10 mt-16 md:grid-cols-3 md:ml-14">
            <div className = "flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[29rem] sm:w-[38rem] md:w-[20rem]">Open Dooly on any site to create or update any opportunity, account, contact, or lead</p>
