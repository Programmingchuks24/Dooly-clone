...
function Fourth() {
  return (
    <div className="w-auto h-[100rem] pt-12 md:h-[47rem] sm:h-[88rem]">
        ...
        <div className="grid grid-rows-1 gap-10 mt-16 md:grid-cols-3 md:ml-14">
            <div className = "flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[21rem] sm:w-[38rem] md:w-[20rem]">Open Dooly on any site to create or update any opportunity, account, contact, or lead</p>
            ...
            <div className="flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[21rem] sm:w-[38rem] md:w-[20rem]">Start a smart note from your calendar and auto-add attendees to your note.</p>
            </div>
            ...
            <div className="flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[21rem] sm:w-[38rem] md:w-[20rem]">Dooly follows your outbound motion in Outreach so critical field updates and call notes make it back to Salesforce.</p>
            </div>
            ...
            <div className="flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[21rem] sm:w-[38rem] md:w-[20rem]">Collaborate with key stakeholders and keep your team in the loop by getting deal updates in Slack.</p>
            </div>
            ...
            <div className="flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[21rem] sm:w-[38rem] md:w-[20rem]">Watch Gong calls within your Dooly notes to get key details and action items from the call into Salesforce instantly.</p>
            </div>
            ...
            <div className="flex flex-col gap-3 ml-4">
                ...
                <p className = "w-[21rem] sm:w-[38rem] md:w-[20rem]">Get your prospects’ LinkedIn profiles displayed right in your meeting note, like your personal assistant for prepwork.</p>
            </div>
