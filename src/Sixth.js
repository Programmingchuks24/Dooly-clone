...
function Sixth() {
  return (
    <div className = "w-auto h-[130rem] bg-zinc-900 text-white sm:h-[125rem] md:h-[60rem]">
        ...
        <p className="text-5xl font-bold text-center w-[29rem] leading-[4rem] ml-3 sm:w-[40rem] md:ml-[24rem]">Dooly powers every team in your revenue organization.</p>

        <div className = " flex flex-col md:flex-row md:ml-[1rem] md:mt-20 sm:ml-20">
            <div className="mt-10 flex flex-col gap-4 md:m-0">
                <img src = {pic1} alt = "sales" className = "w-[20rem] h-[20rem] rounded-lg ml-24"/>
            ...
            <div className="mt-10 flex flex-col gap-4 md:m-0">
                <img src = {pic2} alt = "sales" className = "w-[20rem] h-[20rem] rounded-lg ml-24"/>
            ...
            <div className="mt-10 flex flex-col gap-4 md:m-0">
                <img src = {pic3} alt = "sales" className = "w-[20rem] h-[20rem] rounded-lg ml-24"/>
